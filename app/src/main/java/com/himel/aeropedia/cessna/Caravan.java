...
public class Caravan extends AppCompatActivity {
    ...
    private void renewItems(View view) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if (i == 0) {
                sliderItem.setImageLocation(R.drawable.cessna_caravan_slider1);
            } else if (i == 1) {
                sliderItem.setImageLocation(R.drawable.cessna_caravan_slider2);
            } else if (i == 2) {
                sliderItem.setImageLocation(R.drawable.cessna_caravan_slider3);
            } else if (i == 3) {
                sliderItem.setImageLocation(R.drawable.cessna_caravan_slider4);
            }
