...
public class CitationLatitude extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            window.setStatusBarColor(Color.parseColor("#ff1b6bb4"));
        }
    ...
    private void createTreeView() {
        ...
        if (verifyDarkMode().equals("Yes")) {
            latitude = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, this.getString(R.string.citation_latitude), "HighlightLight", "latitude", null));
        } else {
            latitude = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, this.getString(R.string.citation_latitude), "HighlightDark", "latitude", null));
        }
