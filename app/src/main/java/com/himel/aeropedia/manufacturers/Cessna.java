...
public class Cessna extends AppCompatActivity {
    ...
    private CardView caravanCard;
    private CardView skylaneCard;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        caravanCard = findViewById(R.id.caravanCard);
        skylaneCard = findViewById(R.id.skylaneCard);
        ...
        caravanCard.getBackground().setAlpha(65);
        skylaneCard.getBackground().setAlpha(65);
        ...
        caravanCard.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getBaseContext(), Caravan.class);
                startActivity(intent);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
            }
        });

        skylaneCard.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getBaseContext(), Skylane.class);
                startActivity(intent);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
            }
        });
    ...
    private void animateCards() {
        ...
        caravanCard.setAnimation(translate);
        skylaneCard.setAnimation(translate);
    }
