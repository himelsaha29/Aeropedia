...
public class AirbusA310 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(enableDark.equals("No")) {
            setContentView(R.layout.activity_airbus_a310_light);
        } else {
    ...
    private void createTreeView() {
        ...
        if (verifyDarkMode().equals("Yes")) {
            a310Node = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, this.getString(R.string.a310), "HighlightLight", "a310", null));
        } else {
            a310Node = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, this.getString(R.string.a310), "HighlightDark", "a310", null));
        }
        ...
        TreeNode b787 = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, "B787", "No", "b787", Boeing787.class));
    ...
    private void renewItems(View view) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if (i == 0) {
                sliderItem.setImageLocation(R.drawable.a310_slider01);
            } else if (i == 1) {
                sliderItem.setImageLocation(R.drawable.a310_slider02);
            } else if (i == 2) {
                sliderItem.setImageLocation(R.drawable.a310_slider03);
            } else if (i == 3) {
                sliderItem.setImageLocation(R.drawable.a310_slider04);
            }
