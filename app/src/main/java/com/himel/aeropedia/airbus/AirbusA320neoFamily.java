...
public class AirbusA320neoFamily extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(enableDark.equals("No")) {
            setContentView(R.layout.activity_airbus_a320neo_family_light);
        } else {
            setContentView(R.layout.activity_airbus_a320neo_family_dark);
        }
    ...
    private void createTreeView() {
        ...
        TreeNode a320neoNode = null;
        if (verifyDarkMode().equals("Yes")) {
            a320neoNode = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, this.getString(R.string.a320neofamily), "HighlightLight", "a320neofamily", null));
        } else {
            a320neoNode = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, this.getString(R.string.a320neofamily), "HighlightDark", "a320neofamily", null));
        }
