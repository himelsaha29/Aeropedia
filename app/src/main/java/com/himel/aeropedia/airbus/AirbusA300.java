...
public class AirbusA300 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(enableDark.equals("No")) {
            setContentView(R.layout.activity_airbus_a300_light);
        } else {
            setContentView(R.layout.activity_airbus_a300_dark);
        }
    ...
    private void createTreeView() {
        ...
        if (verifyDarkMode().equals("Yes")) {
            a300Node = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, this.getString(R.string.a300), "HighlightLight", "a300", null));
        } else {
            a300Node = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, this.getString(R.string.a300), "HighlightDark", "a300", null));
        }
