...
public class AirbusA350 extends AppCompatActivity {
    ...
    private void createTreeView() {
        ...
        if (verifyDarkMode().equals("Yes")) {
            a350Node = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, this.getString(R.string.a350), "HighlightLight", "a350", null));
        } else {
            a350Node = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, this.getString(R.string.a350), "HighlightDark", "a350", null));
        }
