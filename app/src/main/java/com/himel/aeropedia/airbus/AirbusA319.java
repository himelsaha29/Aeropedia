...
public class AirbusA319 extends AppCompatActivity {
    ...
    private void createTreeView() {
        ...
        if (verifyDarkMode().equals("Yes")) {
            a319Node = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, this.getString(R.string.a319), "HighlightLight", "a319", null));
        } else {
            a319Node = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, this.getString(R.string.a319), "HighlightDark", "a319", null));
        }
    ...
    private void renewItems(View view) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (i == 0) {
                sliderItem.setImageLocation(R.drawable.a319_slider01);
            } else if (i == 1) {
                sliderItem.setImageLocation(R.drawable.a319_slider02);
            } else if (i == 2) {
                sliderItem.setImageLocation(R.drawable.a319_slider03);
            }
