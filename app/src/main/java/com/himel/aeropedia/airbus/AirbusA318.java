...
public class AirbusA318 extends AppCompatActivity {
    ...
    private void createTreeView() {
        ...
        if (verifyDarkMode().equals("Yes")) {
            a318Node = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, this.getString(R.string.a318), "HighlightLight", "a318", null));
        } else {
            a318Node = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, this.getString(R.string.a318), "HighlightDark", "a318", null));
        }
