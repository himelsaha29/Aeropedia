...
public class AirbusA330neo extends AppCompatActivity {
    ...
    private void createTreeView() {
        ...
        TreeNode a330neoNode = null;
        if (verifyDarkMode().equals("Yes")) {
            a330neoNode = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, this.getString(R.string.a330neo), "HighlightLight", "a330neo", null));
        } else {
            a330neoNode = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, this.getString(R.string.a330neo), "HighlightDark", "a330neo", null));
        }
    ...
    private void renewItems(View view) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (i == 0) {
                sliderItem.setImageLocation(R.drawable.a330_neo_slider0);
            } else if (i == 1) {
                sliderItem.setImageLocation(R.drawable.a330_neo_slider2);
            } else if (i == 2) {
                sliderItem.setImageLocation(R.drawable.a330_neo_slider3);
            }
