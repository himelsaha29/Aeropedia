...
public class AirbusA330 extends AppCompatActivity {
    ...
    private void createTreeView() {
        ...
        if (verifyDarkMode().equals("Yes")) {
            a330Node = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, this.getString(R.string.a330), "HighlightLight", "a330", null));
        } else {
            a330Node = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, this.getString(R.string.a330), "HighlightDark", "a330", null));
        }
