...
public class AirbusA380 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(enableDark.equals("No")) {
            setContentView(R.layout.activity_airbus_a380);
        } else {
    ...
    private void createTreeView() {
        ...
        if (verifyDarkMode().equals("Yes")) {
            a380Node = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.ic_drive_file, this.getString(R.string.a380), "HighlightLight", "a380", null));
        } else {
            a380Node = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.ic_drive_file, this.getString(R.string.a380), "HighlightDark", "a380", null));
        }
