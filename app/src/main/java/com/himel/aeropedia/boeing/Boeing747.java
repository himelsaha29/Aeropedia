...
public class Boeing747 extends AppCompatActivity {
    ...
    private void renewItems(View view) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if (i == 0) {
                sliderItem.setImageLocation(R.drawable.boeing_747_slider01);
            } else if (i == 1) {
                sliderItem.setImageLocation(R.drawable.boeing_747_slider02);
            } else if (i == 2) {
                sliderItem.setImageLocation(R.drawable.boeing_747_slider03);
            } else if (i == 3) {
                sliderItem.setImageLocation(R.drawable.boeing_747_slider04);
            }
