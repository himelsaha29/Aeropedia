...
public class Boeing787 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(enableDark.equals("No")) {
            setContentView(R.layout.activity_boeing_787);
        } else {
    ...
    private void createTreeView() {
        ...
        if (verifyDarkMode().equals("Yes")) {
            b777 = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, this.getString(R.string.b777), "HighlightLight", "b777", null));
        } else {
            b777 = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, this.getString(R.string.b777), "HighlightDark", "b777", null));
        }
    ...
    private void renewItems(View view) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if (i == 0) {
                sliderItem.setImageLocation(R.drawable.boeing_787_slider1);
            } else if (i == 1) {
                sliderItem.setImageLocation(R.drawable.boeing_787_slider2);
            } else if (i == 2) {
                sliderItem.setImageLocation(R.drawable.boeing_787_slider3);
            } else if (i == 3) {
                sliderItem.setImageLocation(R.drawable.boeing_787_slider4);
            }
