...
public class G650 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(enableDark.equals("No")) {
            setContentView(R.layout.activity_gulfstream_g650_light);
        } else {
            setContentView(R.layout.activity_gulfstream_g650_dark);
        }
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            Window window = getWindow();
            window.clearFlags(WindowManager.LayoutParams.FLAG_LAYOUT_NO_LIMITS);
            window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
            window.setStatusBarColor(Color.parseColor("#ff527baf"));
        }
    ...
    private void renewItems(View view) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if (i == 0) {
                sliderItem.setImageLocation(R.drawable.gulfstream_g650_slider01);
            } else if (i == 1) {
                sliderItem.setImageLocation(R.drawable.gulfstream_g650_slider02);
            } else if (i == 2) {
                sliderItem.setImageLocation(R.drawable.gulfstream_g650_slider03);
            } else if (i == 3) {
                sliderItem.setImageLocation(R.drawable.gulfstream_g650_slider04);
            }
