...
public class G280 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            window.setStatusBarColor(Color.parseColor("#ff6c9ed3"));
        }
    ...
    private void createTreeView() {
        ...
        if (verifyDarkMode().equals("Yes")) {
            g280 = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, this.getString(R.string.g280), "HighlightLight", "g280", null));
        } else {
            g280 = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, this.getString(R.string.g280), "HighlightDark", "g280", null));
        }
