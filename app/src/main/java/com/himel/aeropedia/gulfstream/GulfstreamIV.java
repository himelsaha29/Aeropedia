package com.himel.aeropedia.gulfstream;
...
public class GulfstreamIV extends AppCompatActivity {
    ...
    private void createTreeView() {
        ...
        if (verifyDarkMode().equals("Yes")) {
            gulfstreamIV = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, this.getString(R.string.gulfstream_iv), "HighlightLight", "gulfstreamIV", null));
        } else {
            gulfstreamIV = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.drawer_tail, this.getString(R.string.gulfstream_iv), "HighlightDark", "gulfstreamIV", null));
        }
    ...
    private void renewItems(View view) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if (i == 0) {
                sliderItem.setImageLocation(R.drawable.gulfstream_giv_slider01);
            } else if (i == 1) {
                sliderItem.setImageLocation(R.drawable.gulfstream_giv_slider03);
            } else if (i == 2) {
                sliderItem.setImageLocation(R.drawable.gulfstream_giv_slider02);
            } else if (i == 3) {
                sliderItem.setImageLocation(R.drawable.gulfstream_giv_slider04);
            }
